...
- Оценка по 5 метрикам: MECLABS, LIFT, Scannability Score, Trust Factor, Resonance Rate
...
LLM-агент анализирует страницу, применяя 5 метрик:
- **MECLABS** — формула конверсии (C = M×4 + V×3 + I×2 + F×2 + A×2)
- **LIFT** — 6 факторов влияния на конверсию (Drivers − Inhibitors)
- **Scannability Score** — сканируемость за 5 секунд (H1, Subheadline, CTA, структура, визуал, воздух)
- **Trust Factor** — взвешенная сумма триггеров доверия (отзывы, гарантия, рейтинги, контакты)
- **Resonance Rate** — % болей ICP, закрытых контентом страницы
...
| Метрика | Описание |
|---------|----------|
| **CRO Score** | Итоговая оценка конверсии (0-100) |
| **VPI** | Value Proposition Index — сила ценностного предложения |
